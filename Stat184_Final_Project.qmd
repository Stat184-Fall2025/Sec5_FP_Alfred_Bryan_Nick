...
```{r}
#| label: fig-eraTime
#| fig-cap: "Visual of Pitching ERA Over Time"
#| fig-alt: "Line graph showing pitching ERA over time from 2001 to 2025, with ERA values ranging from 3.75 to 4.50."
#| fig-pos: H
...
```{r}
#| label: fig-so9Time
#| fig-cap: "Visual of Strikeouts per 9 Innings Over Time"
#| fig-alt: "Line graph of MLB strikeouts per 9 innings from 2000 to 2025, showing a gradual increase with peaks above 9 in the early 2020s."
#| fig-pos: H
...
```{r}
#| label: fig-eraso9Time
#| fig-cap: "Visual of ERA and Strikeouts per 9 Innings Over Time"
#| fig-alt: "Line graph showing ERA and SO9 over time, with ERA slightly declining and SO9 increasing from 2000 to 2025."
#| fig-pos: H
...
ggplot(pitching_long, aes(x = Year, y = Value, color = Metric)) +
  geom_line() +
  labs(title = "ERA and Strikeouts per 9 Innings Over Time",
       x = "Year",
       y = "Value") +
  theme_minimal()
```
...
```{r}
#| label: fig-avgIPTime
#| fig-cap: "Visual of Average Innings Pitched per Pitcher per Season"
#| fig-alt: "Line graph of average innings pitched per pitcher per season from 2000 to 2025, showing an overall decline with a sharp drop around 2020."
#| fig-pos: H
...
```{r}
#| label: fig-avgNoPitchTime
#| fig-cap: "Visual of Average Number of Pitchers Used per Team per Season"
#| fig-alt: "Line graph showing the average number of pitchers used per team per season from 2000 to 2025, with an upward trend."
#| fig-pos: H
#| lst-label: lst-figure5
#| lst-cap: "Code Chunk for Making Visual"
#| echo: false
#| 
...
```{r}
#| label: fig-BABIPTime
#| fig-cap: "Visual of League Average BABIP Over Time"
#| fig-alt: "Line graph showing league average BABIP from 2000 to 2025 with a fluctuating solid line and horizontal dashed baseline."
#| fig-pos: H
#| lst-label: lst-figure6
#| lst-cap: "Code Chunk for Making Visual"
#| echo: false
#| 
...
```{r}
#| label: fig-eraAge
#| fig-cap: "Visual of Average ERA vs Average Pitcher Age"
#| fig-alt: "Line graph showing the trend of average ERA versus average pitcher age with a gray shaded confidence interval."
#| fig-pos: H
#| lst-label: lst-figure7
#| lst-cap: "Code Chunk for Making Visual"
#| echo: false
#| 
